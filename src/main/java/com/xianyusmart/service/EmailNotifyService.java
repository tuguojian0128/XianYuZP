...
public interface EmailNotifyService {
    ...
    /**
     * 发送自动发货失败订单通知，并按订单事件去重。
     */
    void sendAutoDeliveryFailEmail(Long accountId, String toEmail, String xyGoodsId, String orderId, String failReason);

    /**
     * 发送带本地订单记录标识的自动发货失败通知。
     */
    void sendAutoDeliveryFailEmail(Long accountId, Long recordId, String toEmail,
                                   String xyGoodsId, String orderId, String failReason);

    /**
     * 发送新订单通知，并按订单事件去重。
     */
    void sendOrderCreatedEmail(Long accountId, Long recordId, String orderId, String xyGoodsId,
                               String buyerUserName, boolean reviewRequired);

    /**
     * 发送发货成功通知，并按订单事件去重。
     */
    void sendDeliverySuccessEmail(Long accountId, Long recordId, String orderId, String xyGoodsId,
                                  String deliveryMode);
